...
**Commands:**\n
> :space_invader: `{prefix}plasma` - Show my social networks.
...
> :hammer: `{prefix}whremove <webhook>` - Remove a webhook.
...
async def geoip(ctx, ip: str=None):
    ...
    try:
        ...
        > :electric_plug: `As`\n*{geo['as']}*"""
        await ctx.send(embed, file=discord.File("img/plasma.gif"))
